      ...
      return (
       <View>
        ...
        <ScrollView>
          ...
          <SafeAreaView>
            ...
            <View visible="false" style={{flex: 0.5, flexDirection: 'row'}}>
                <View style={{flex: 0.5, flexDirection: 'column', borderRadius: 0.5}}>
                    ...
                    <Text style={styles.spendingTextGrey}>{"£" + this.state.TodaysTotal}</Text>
                </View>
                <View style={{flex: 0.5, flexDirection: 'column', borderRadius: 0.5}}>
                    <Text style={styles.spendingTitleGrey}>{"Past 7 Days:"}</Text>
                    <Text style={styles.spendingTextGrey}>{"£" + this.state.WeeksTotal}</Text>
                </View>
                <View style={{flex: 0.5, flexDirection: 'column', borderRadius: 0.5}}>
                    <Text style={styles.spendingTitleGrey}>{"This Year:"}</Text>
                    <Text style={styles.spendingTextGrey}>{"£" + this.state.YearsTotal}</Text>
                </View>
          ...
          <View style={{flex: 0.5, flexDirection: 'row'}}><Text>{"\n"}</Text></View>
          <View style={{flex: 2, flexDirection: 'row', alignItems: 'center'}}>
          <Text style={styles.gaugeText}>{"\t" + this.state.percentOverBudget.toString().substring(0, 5) + "% Trips\n\tOver-Budget"}</Text>
            <Pie
              radius={80}
              innerRadius={70}
              series={[this.state.percentOverBudget]}
              colors={['#f00']}
              backgroundColor="#ddd"
            />
          </View>
